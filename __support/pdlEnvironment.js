...
function leadlinediagram(thecomment, xloc, yloc){
    var yoffset=yloc-30;
    var xoffset=xloc+25;
...
function leadlinediagramdeep(thecomment, xloc, yloc){
    var yoffset=yloc-90;
    var xoffset=xloc+75;
    var leadlinelength =40;
    strokeWeight(1);
...
function leadlinediagramshort(thecomment, xloc, yloc){
    var yoffset=yloc-15;
    var xoffset=xloc+12;
    var leadlinelength =40;
    strokeWeight(1);
...
function leadlinediagramnegative(thecomment, xloc, yloc){
    var yoffset=yloc+30;
    var xoffset=xloc+25;
    var leadlinelength =40;
    strokeWeight(1);
...
function leadlinediagramnegativedeep(thecomment, xloc, yloc){
    var yoffset=yloc+60;
    var xoffset=xloc+50;
    var leadlinelength =40;
    strokeWeight(1);
...
push();
	scale(0.5);
	discoursedroid(11,2*(xloc+4),2*(yloc+4),false,false,cideaGreen,2);
pop();
const saymargin=5;
const tailparameter =15;
	fill(ctalkbubbleBG);
...
function thinkWT(thinkThis,xloc,yloc, bubblewidth,bubbleheight){
push();
	scale(0.5);
	discoursedroid(9,2*(xloc+4),2*(yloc+6),true,false,cideaRed,2);
pop();
const saymargin=5;
const tailparameter =15;
	fill(ctalkbubbleBG);
...
function mentonthink(droidid,droidpose,thinkThis,bubbleloc){
	stroke(droidid);
	noFill();
	
	discoursedroid(droidpose,mentonthinkloc[0],mentonthinkloc[1],bubbleloc=="R",false,droidid,2);
	
	if (bubbleloc=="L"){
	mentonbubbleTL(thinkThis,mentonthinkloc[0],mentonthinkloc[1], mentonthinkchain[0][0],mentonthinkchain[0][1]);
	const flipdroid =true;
	}
	if (bubbleloc=="R"){
	mentonbubbleTR(thinkThis,mentonthinkloc[0],mentonthinkloc[1], mentonthinkchain[0][0],mentonthinkchain[0][1]);
	const flipdroid =false;
	}
}
	

function mentonthinkmore(chainposition,mentontext){
	const saymargin=5;
	fill(ctalkbubbleBG);
	noStroke();
	const xtraoffset=30;
	rect(mentonthinkchain[chainposition-1][0]+xtraoffset, -xtraoffset, mentonthinkchain[chainposition][0], mentonthinkchain[chainposition][1],5);
	console.log(mentonthinkchain[chainposition-1][0]);
	if(mentonthinkchain[chainposition][2]=="evolve"){
		transitionEvolve(mentonthinkchain[chainposition-1][0]+xtraoffset/2,+xtraoffset,0);
	}
	if(mentonthinkchain[chainposition][2]=="redescribe"){
		transitionRedescribe(mentonthinkchain[chainposition-1][0]+xtraoffset/2,+xtraoffset,0);
	}
	if(mentonthinkchain[chainposition][2]=="intervene"){
		transitionIntervene(mentonthinkchain[chainposition-1][0]+xtraoffset/2,+xtraoffset,0);
	}
	if(mentonthinkchain[chainposition][2]=="step"){
		transitionStep(mentonthinkchain[chainposition-1][0]+xtraoffset/2,+xtraoffset,0);
	}
	fill(clabeltext);
	textFont(chatterFont);
	noStroke();
	textSize(16);
	text(mentontext, mentonthinkchain[chainposition-1][0]+xtraoffset+saymargin, -xtraoffset+saymargin, mentonthinkchain[chainposition][0]-2*saymargin, mentonthinkchain[chainposition][1]);
	translate(mentonthinkchain[chainposition-1][0]+xtraoffset, -xtraoffset);
}
...
function linkArrowDown(xloc,yloc,lengthofArrow){
    var widthOfArrow = 8;
    var widthOfArrowHead = 24;
    var heightOfArrowHead = 18;
    var arrowIndent =8;
...
function linkArrowRight(xloc,yloc,lengthofArrow){
    var widthOfArrow = 8;
    var widthOfArrowHead = 24;
    var heightOfArrowHead = 18;
    var arrowIndent =8;
...
function linkArrowLeft(xloc,yloc,lengthofArrow){
push();
		translate(xloc,yloc);
		rotate(PI);
		linkArrowRight(0, 0, lengthofArrow);
	pop();
}
...
function linkBarUp(xloc,yloc,lengthBar){
	var widthOfBar = 8;
	noStroke();
	fill(cWhite);
...
function IanSlider(xPos,yPos,sliderheight,sliderwidth,noOfSteps,handlepostions,showlabel,top,left)
{
...
IanSlider.prototype.init=function()
{
 ...
 /**
   ...
   **/
IanSlider.prototype.getValue=function(index)
  {
   ...
   **/
  IanSlider.prototype.setValue=function(index,value)
  {
...
IanSlider.prototype.mouseReleased=function()
{
	this.isMouseDown=false;
}
